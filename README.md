...
Try it !
The REW measurement is in the Rew Measurements fiolder, this file can be downloaded to a directory on your computer and you can load it into REW and try the EQ function to get a feel for the procedure. 
To download: Right click the .mdat file and save it to a folder on your computer.
